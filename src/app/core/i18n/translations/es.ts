...
export const es = {
  ...
  completeProfile: {
    ...
    popupDesc: 'Necesitamos algunos datos para terminar de configurar tu cuenta.',
    noticeTitle: 'Completa tu perfil',
    noticeDesc:
      'Termina de configurar tu cuenta respondiendo unas preguntas rápidas.',
  ...
  datosIa: {
    ...
    dropout: {
      ...
      labels: {
        ...
        applicationOrder: 'Orden de preferencia de la carrera',
      ...
      hints: {
        ...
        applicationOrder: 'En qué lugar estaba esta carrera en tu lista (0 = primera opción).',
