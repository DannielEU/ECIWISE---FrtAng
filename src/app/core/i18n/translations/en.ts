...
export const en = {
  ...
  games: {
    ...
    asclepio: {
      name: 'Asclepio',
      tagline: 'Devour ideas, grow and outscore your classmates in real time.',
      subject: 'Multiplayer arena',
    },
    modes: {
      label: 'Pick a mode',
      classic: 'Classic',
      classicDesc: 'Free arena, no time limit. Grow as much as you can.',
      pomodoro: 'Pomodoro',
      pomodoroDesc: 'Score as many points as possible before time runs out.',
      battleroyale: 'Exam week',
      battleroyaleDesc: 'The safe zone closes in: survive to the end.',
    },
    hud: {
      score: 'Score',
    ...
    controls: {
      hint: 'Move with the mouse · Hold click or Shift to sprint · Space splits · W ejects mass',
      sprint: 'Sprint',
      split: 'Split',
      eject: 'Eject mass',
    },
    ...
    status: {
      ...
      error: 'Could not connect to the game. Try again.',
      offline: 'The game server is unavailable.',
    },
    death: {
      title: 'You were beaten',
      eatenBy: '{{name}} caught you',
