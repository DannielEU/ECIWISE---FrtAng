...
export const en = {
  ...
  completeProfile: {
    ...
    popupDesc: 'We need a few details to finish setting up your account.',
    noticeTitle: 'Complete your profile',
    noticeDesc:
      'Finish setting up your account by answering a few quick questions.',
  ...
  datosIa: {
    ...
    dropout: {
      ...
      labels: {
        ...
        applicationOrder: 'Program preference order',
      ...
      hints: {
        ...
        applicationOrder: 'Where this program ranked in your choices (0 = first choice).',
